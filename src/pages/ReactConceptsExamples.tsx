...
export default function ReactConceptsExamples() {
  return (
    <div style={{paddingTop:"150px", maxWidth: 800, margin: '0 auto', lineHeight: 1.6 }}>
      <h1>Conceptos de React</h1>
      <p>Esta página te explica los conceptos clave de React usando ejemplos reales.</p>
      <hr />
      <ProjectStructure />
      <ComponentsExample />
      <PropsExample />
